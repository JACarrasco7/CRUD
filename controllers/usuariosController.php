...
class usuariosController
{
    ...
    public function ctrMostrarUsuarios($campo, $valor)
    {
        ...
        $tabla = "usuarios";
        $respuesta = usuariosModel::mdlMostrarUsuarios($tabla, $campo, $valor);
        return $respuesta;
    }
            ...
            if (
                ...
                if ($respuesta["usuario"] == $_POST["usuario"] && $respuesta["password"] == $encriptada) {
                    if ($respuesta["estado"] == 1) {
                        ...
                        $ultimoLogin = usuariosModel::mdlActualizarCampoUsuario($tabla, $campo1, $valor1, $campo2, $valor2);
                    ...
                    echo '<br><div class="alert alert-danger">Los datos introducidos no coinciden dentro</div>';
                }
            } else {
            ...
            if (
                ...
                if (isset($_FILES["nuevaFoto"]["tmp_name"])) {
                    ...
                    if ($_FILES["nuevaFoto"]["type"] == "image/jpeg") {
                        $ruta = "views/img/usuarios/" . $_POST["nuevoUsuario"] . "/" . $_POST["nuevoUsuario"] . ".jpg";
            ...
            if (preg_match('/^[a-zA-Z0-9ñÑáéíóúÁÉÍÓÚ ]+$/', $_POST["editarNombre"]) && !empty($_POST["editarNombre"])) {
                ...
                if (isset($_FILES["editarFoto"]["tmp_name"]) && !empty($_FILES["editarFoto"]["tmp_name"])) {
                    ...
                    if ($_FILES["editarFoto"]["type"] == "image/jpeg") {
                        $ruta = "views/img/usuarios/" . $_POST["editarUsuario"] . "/" . $_POST["editarUsuario"] . ".jpg";
                    ...
                    if ($_FILES["editarFoto"]["type"] == "image/png") {
                        $ruta = "views/img/usuarios/" . $_POST["editarUsuario"] . "/" . $_POST["editarUsuario"] . ".png";
    ...
    public function ctrBorrarUsuario()
    {
        if (isset($_GET["idUsuario"])) {
            if ($_SESSION['id'] != $_GET['idUsuario']) {
                ...
                $respuesta = usuariosModel::mdlBorrarUsuarios($tabla, $datos);
            ...
            swal({
                type: "error",
                title: "¡No puedes borrar un usuario si esta en uso!",
                showConfirmButton: true,
                confirmButtonText: "Cerrar",
                closeOnConfirm: false,
            }).then((result)=>{
